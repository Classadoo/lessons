...
/***/ function(module, exports, __webpack_require__) {
	...
	__importedLesson = [
		...
		// break and talk about inline vs. block

		InvestigateInlineNewsImage,
		PutNewsImageInsideDiv,	
		ChangeImageWidth,
		ChangeNewsImageMarginTop,
		AddArticleDiv,		
		AddArticles,

		// break and walk through this part together

		GiveArticlesIds,
		MarkArticlesInline,
		AddArticleText,
		MakeArticlesInlineBlock,
		GiveArticlesFixedWidth,
		CenterArticles,
		AdjustArticlesMarginTop

		// talk about why the text is all together. How do we separate it into multiple boxes?
	]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var H = __webpack_require__(2);
	var IframeManager = __webpack_require__(4);
	var $ = __webpack_require__(3)
	...
	AddImage = new function() {	
		this.description = 'Try adding an image to your site. Use a tag like img src="some/url.png". Set the src to any image url from google images.',
	...
	ButtonBorders = new function() {	
		this.description = 'Bonus Challenge: let\'s try draw a box around our "Search" and "I\'m feeling lucky" buttons. To learn what property to use try googling "css border"',
		this.hint = "use 'style'"
		this.location = "scratchpad.io"
